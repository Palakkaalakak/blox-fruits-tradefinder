...
**The mountains are the only unbroken ground.** Fractures deflect around a mountain root rather than crossing it — the crack front takes the weakness, and a range is not weak. Note the distinction precisely: what deflects a crack is a *ridge*, ground standing proud of its surroundings. A high plateau is not a mountain in this sense and fractures like anywhere else, so an elevated continent is broken up just as thoroughly as a low one. So the highlands came through the Doom whole, and they are the only places in the world where you can travel any distance without a boat.
