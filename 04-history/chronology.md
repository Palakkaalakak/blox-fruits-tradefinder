...
**Language fragments hard, the way it really would.** Several centuries of total silence between isolated clusters is enough time for everyday speech to diverge into many mutually unintelligible local languages and dialects — this is what happened to spoken Latin in our own history over a comparable span, and there's no reason for this world to do better. Latin and Greek survive as *written*, scholarly languages among the literate few (per `01-cataclysm/the-doom.md` §3), but that's a bridge for scholars and books, not something ordinary people from two different clusters can lean on to understand each other when contact resumes. Meeting a stranger from another cluster, even late in the Dark Age, plausibly means meeting someone whose speech you can't follow at all. See `03-peoples/names-and-languages.md` for how this plays out region by region.

**Authority starts as unofficial consensus, not inheritance.** In the earliest years, nobody has the standing to simply declare hereditary rule — nobody even knows what happened to the world yet. Leadership is a mix of raw strength, rough consensus among survivors, and control of whatever resource the group depends on, with no fixed formula. It's only later, once a family has held power long enough for the memory of exactly *how* they first got it to fade, that succession calcifies into something treated as automatic and sacred.
