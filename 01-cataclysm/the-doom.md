...
**Knowledge preservation was not total, though.** In the years before the Doom, AI data centres had been digitising books at mass scale — destroying the spine, scanning each page, then pulping what remained — as part of feeding training data to their models. Some of what those centres processed no longer existed as physical books by the time of the Doom, only as data on servers that lost power in the collapse and were never recovered. This is the excuse for some knowledge simply not surviving in any form.

What did survive, survived unevenly. Surviving books gave the post-Doom world general knowledge rather than exhaustive detail — people knew a combustion engine existed and roughly how it worked, without every book on the specific engineering inside a given car having survived. It took centuries longer, as recovery progressed, for people to work out how to pull data off dead old-world servers — and only once that became possible did the more detailed, digitally-stored knowledge become available again, on top of what the books had already given back. This is why the modern world's technology is uneven rather than uniform: horses and supercars on the same road, windmills next to an airport. Different pieces of the old world's knowledge came back on different timelines, and industry and population never grew back to a scale that could apply all of it evenly.
